...
export default {
  ...
  data () {
    return {
      ...
      row: [
        ...
        { desc: 'Passività consolidate + CN', class: '', cod: 'PMLT_PN', values: [{ anno: 2019, value: '' }] },
        ...
        { desc: 'debiti non finanziari entro 12 mesi', class: '', cod: 'DEBNONFINENTR12MESI', values: [{ anno: 2019, value: '' }] },
  ...
  methods: {
    ...
    master (anno, cod) {
      switch (cod) {
        ...
        case 'PO.A1':
          ...
          break;
        case 'PO.A1a':
          this.startPOA1a(anno);
          break;
        case 'PO.A1b':
          this.startPOA1b(anno);
          break;
        case 'PO.A1c':
          this.startPOA1c(anno);
          break;
        case 'PO.A1d':
          this.startPOA1d(anno);
          break;
        case 'PO.A1e':
          this.startPOA1e(anno);
          break;
        case 'PO.A2':
          this.startPOA2(anno);
          break;
        case 'PO.A2a':
          this.startPOA2a(anno);
          break;
        case 'PO.A2b':
          this.startPOA2b(anno);
          break;
        case 'PO.A2c':
          this.startPOA2c(anno);
          break;
        case 'PO.A2d':
          this.startPOA2d(anno);
          break;
        case 'PO.A2e':
          this.startPOA2e(anno);
          break;
        case 'PO.A3':
          this.startPOA3(anno);
          break;
        case 'PO.A3a':
          this.startPOA3a(anno);
          break;
        case 'PO.A3b':
          this.startPOA3b(anno);
          break;
        case 'PO.A3c':
          this.startPOA3c(anno);
          break;
        case 'PO.A3d':
          this.startPOA3d(anno);
          break;
        case 'PO.A3e':
          this.startPOA3e(anno);
          break;
        case 'PO.A4':
          this.startPOA4(anno);
          break;
        case 'PO.A4a':
          this.startPOA4a(anno);
          break;
        case 'PO.A4b':
          this.startPOA4b(anno);
          break;
        case 'PO.A4c':
          this.startPOA4c(anno);
          break;
        case 'PO.A4d':
          this.startPOA4d(anno);
          break;
        case 'PO.A4e':
          this.startPOA4e(anno);
          break;
        case 'PO.A5':
          this.startPOA5(anno);
          break;
        case 'PO.A5a':
          this.startPOA5a(anno);
          break;
        case 'PO.A5b':
          this.startPOA5b(anno);
          break;
        case 'PO.B':
          this.startPOB(anno);
          break;
        ...
        case 'LD2':
          ...
          break
        case 'CROLTRE12':
          this.startCROLTRE12(anno)
          break
        case 'ATTFINNONIMM':
          this.startATTFINNONIMM(anno)
          break
        case 'LI':
          this.startLI(anno)
          break
        case 'RATRISATT':
          this.startRATRISATT(anno)
          break
        case 'ATTCORR':
          this.startATTCORR(anno)
          break
        case 'LIQCRERAT':
          this.startLIQCRERAT(anno)
          break
        case 'ATTCORRLIQ':
          this.startATTCORRLIQ(anno)
          break
        case 'CI':
          this.startCI(anno)
          break
        ...
        case 'PMLT':
          ...
          break
        case 'PMLT_PN':
          this.startPMLT_PN(anno)
          break
        case 'DEBFINBT':
          this.startDEBFINBT(anno)
          break
        case 'FORN':
          this.startFORN(anno)
          break
        case 'DFB':
          this.startDFB(anno)
          break
        case 'DEBNONFINENTR12MESI':
          this.startDEBNONFINENTR12MESI(anno)
          break
        case 'RATERIS':
          this.startRATERIS(anno)
          break
        case 'PR':
          this.startPR(anno)
          break
        case 'CAPCIRNET':
          this.startCAPCIRNET(anno)
          break
        case 'TOTFON':
          this.startTOTFON(anno)
          break
      }
    },
    startPA (anno) {
    ...
    startPAC22A (anno) {
      ...
      this.calculateLD2(anno)
    },
    startPAC22B (anno) {
      this.calculatePAC22(anno)
      this.calculateCROLTRE12(anno)
    },
    startPAC23 (anno) {
      this.calculatePAC2(anno)
    },
    ...
    startPPD1a (anno) {
      ...
      this.calculateDEBNONFINENTR12MESI(anno)
    },
    startPPD1b (anno) {
      this.calculatePPD1(anno)
      this.calculateDFB(anno)
    },
    startPPD2 (anno) {
      this.calculatePPD(anno)
    },
    ...
    startPPD3a (anno) {
      ...
      this.calculateDEBFINBT(anno);
    },
    startPPD3b (anno) {
      this.calculatePPD3(anno)
      this.calculateMLT(anno)
    },
    startPPD4 (anno) {
      this.calculatePPD(anno)
    },
    ...
    startPPE(anno){
      this.calculatePP(anno);
      this.calculateRATERIS(anno);
    },
    startPPE1(anno){
      this.calculatePPE(anno);
    },
    startPPE2(anno){
      this.calculatePPE(anno);
    },
    startPO(anno){
      this.calculateP(anno);
    },
    startPOA(anno){
      this.calculatePO(anno);
    },
    startPOA1(anno){
      this.calculatePOA(anno);
    },
    startPOA1a(anno){
      this.calculatePOA1(anno);
    },
    startPOA1b(anno){
      this.calculatePOA1(anno);
    },
    ...
    startIMM (anno) {
      this.calculateATTCONS(anno)
    },
    startATTCONS (anno) {
      this.calculateCI(anno)
    },
    startRIMA (anno) {
      this.calculateATTCORR(anno)
    },
    startLD1 (anno) {
      this.calculateATTCORR(anno)
      this.calculateLIQCRERAT(anno)
    },
    startLD2 (anno) {
      this.calculateATTCORR(anno)
      this.calculateLIQCRERAT(anno)
    ...
    startATTCORR (anno) {
      this.calculateATTCORRLIQ(anno)
      this.calculateCI(anno)
      this.calculateCAPCIRNET(anno)
    },
    startLIQCRERAT (anno) {
    },
    startATTCORRLIQ (anno) {
    },
    startCI (anno) {
    },
    startPN (anno) {
      this.calculatePMLT_PN(anno)
    },
    startFON (anno) {
      this.calculatePMLT(anno)
    },
    startTFR (anno) {
      this.calculatePMLT(anno)
    },
    ...
    startPMLT_PN (anno) {
      this.calculateTOTFON(anno)
    },
    startDEBFINBT (anno) {
      this.calculatePR(anno)
    },
    startFORN (anno) {
      this.calculatePR(anno)
    },
    ...
    calculatePAC (anno) {
      ...
      this.row[this.RIMA].values[indexAnno].value = this.row[this.PAC].values[indexAnno].value
      this.startPAC(anno)
    },
    calculatePAC1 (anno) {
      let indexAnno = 2019 - parseInt(anno)
    ...
    calculatePPE(anno){
      ...
      this.row[this.PPE].values[index_anno].value = this.row[this.PPE1].values[index_anno].value+this.row[this.PPE2].values[index_anno].value;
      this.startPPE(anno);
    },
    ...
    calculateIMM1 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.IMM1].values[indexAnno].value = this.row[this.PAB1].values[indexAnno].value;
      this.startIMM1(anno);
    }
    calculateIMM2 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.IMM2].values[indexAnno].value = this.row[this.PAB2].values[indexAnno].value;
      this.startIMM2(anno);
    }
    calculateIMM3 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.IMM3].values[indexAnno].value = this.row[this.PAB3].values[indexAnno].value;
      this.startIMM3(anno);
    }
    calculateATTCONS (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.ATTCONS].values[indexAnno].value = this.row[this.IMM].values[indexAnno].value
      this.startATTCONS(anno);
    }
    calculateIMM (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.IMM].values[indexAnno].value = this.row[this.IMM1].values[indexAnno].value + this.row[this.IMM2].values[indexAnno].value + this.row[this.IMM3].values[indexAnno].value
      this.startIMM(anno);
    }
    calculateRIMA (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.RIMA].values[indexAnno].value = this.row[this.PAC1].values[indexAnno].value;
      this.startRIMA(anno);
    }
    calculateLD1 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.LD1].values[indexAnno].value = this.row[this.PAC21A].values[indexAnno].value
      this.startLD1(anno)
    }
    calculateLD2 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.LD2].values[indexAnno].value = this.row[this.PAC22A].values[indexAnno].value + this.row[this.PAC23A].values[indexAnno].value + this.row[this.PAC24A].values[indexAnno].value + this.row[this.PAC2BA].values[indexAnno].value + this.row[this.PAC2TA].values[indexAnno].value + this.row[this.PAC25A].values[indexAnno].value
      this.startLD2(anno)
    }
    calculateCROLTRE12 (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.CROLTRE12].values[indexAnno].value = this.row[this.PAC22B].values[indexAnno].value + this.row[this.PAC23B].values[indexAnno].value + this.row[this.PAC24B].values[indexAnno].value + this.row[this.PAC2BB].values[indexAnno].value + this.row[this.PAC2TB].values[indexAnno].value + this.row[this.PAC25B].values[indexAnno].value
      this.startCROLTRE12(anno);
    }
    calculateATTCORR (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.ATTCORR].values[indexAnno].value = this.row[this.RIMA].values[indexAnno].value + this.row[this.LD1].values[indexAnno].value + this.row[this.LD2].values[indexAnno].value + this.row[this.CROLTRE12].values[indexAnno].value + this.row[this.ATTFINNONIMM].values[indexAnno].value + this.row[this.LI].values[indexAnno].value + this.row[this.RATRISATT].values[indexAnno].value
      this.startATTCORR(anno);
    }
    calculateLIQCRERAT (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.LIQCRERAT].values[indexAnno].value = this.row[this.RATRISATT].values[indexAnno].value + this.row[this.LI].values[indexAnno].value + this.row[this.ATTFINNONIMM].values[indexAnno].value + this.row[this.LD2].values[indexAnno].value + this.row[this.LD1].values[indexAnno].value
      this.startLIQCRERAT(anno);
    }
    calculateATTCORRLIQ (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.ATTCORRLIQ].values[indexAnno].value = this.row[this.ATTCORR].values[indexAnno].value - this.row[this.LI].values[indexAnno].value
      this.startATTCORRLIQ(anno);
    }
    calculateCI (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.CI].values[indexAnno].value = this.row[this.ATTCORR].values[indexAnno].value + this.row[this.ATTCONS].values[indexAnno].value
      this.startCI(anno);
    }
    calculatePN (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.PN].values[indexAnno].value = this.row[this.PPA].values[indexAnno].value
      this.startPN(anno);
    }
    calculateFON (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.FON].values[indexAnno].value = this.row[this.PPB].values[indexAnno].value
      this.startFON(anno);
    }
    calculateTFR (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.TFR].values[indexAnno].value = this.row[this.PPC].values[indexAnno].value
      this.startTFR(anno);
    }
    calculateMLT (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.MLT].values[indexAnno].value = this.row[this.PPD3B].values[indexAnno].value
      this.startMLT(anno);
    }
    calculatePMLT (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.PMLT].values[indexAnno].value = this.row[this.FON].values[indexAnno].value + this.row[this.TFR].values[indexAnno].value + this.row[this.MLT].values[indexAnno].value
      this.startPMLT(anno);
    }
    calculatePMLT_PN (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.PMLT_PN].values[indexAnno].value = this.row[this.PMLT].values[indexAnno].value + this.row[this.PN].values[indexAnno].value
      this.startPMLT_PN(anno);
    }
    calculateDEBFINBT (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.DEBFINBT].values[indexAnno].value = this.row[this.PPD3A].values[indexAnno].value
      this.startDEBFINBT(anno);
    }
    calculateFORN (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.FORN].values[indexAnno].value = this.row[this.PPD6A].values[indexAnno].value
      this.startFORN(anno);
    }
    calculateDFB (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.DFB].values[indexAnno].value = this.row[this.PPD1B].values[indexAnno].value + this.row[this.PPD2B].values[indexAnno].value + this.row[this.PPDFB].values[indexAnno].value + this.row[this.PPD4B].values[indexAnno].value + this.row[this.PPD5B].values[indexAnno].value + this.row[this.PPD6B].values[indexAnno].value + this.row[this.PPD7B].values[indexAnno].value + this.row[this.PPD8B].values[indexAnno].value + this.row[this.PPD9B].values[indexAnno].value + this.row[this.PPDAB].values[indexAnno].value + this.row[this.PPDBB].values[indexAnno].value + this.row[this.PPDCB].values[indexAnno].value + this.row[this.PPDDB].values[indexAnno].value
      this.startDFB(anno);
    }
    calculateDEBNONFINENTR12MESI (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.DEBNONFINENTR12MESI].values[indexAnno].value = this.row[this.PPD1A].values[indexAnno].value + this.row[this.PPD2A].values[indexAnno].value + this.row[this.PPDFA].values[indexAnno].value + this.row[this.PPD4A].values[indexAnno].value + this.row[this.PPD5A].values[indexAnno].value + this.row[this.PPD7A].values[indexAnno].value + this.row[this.PPD8A].values[indexAnno].value + this.row[this.PPD9A].values[indexAnno].value + this.row[this.PPDAA].values[indexAnno].value + this.row[this.PPDBA].values[indexAnno].value + this.row[this.PPDCA].values[indexAnno].value + this.row[this.PPDDA].values[indexAnno].value
      this.startDEBNONFINENTR12MESI(anno);
    }
    calculateRATERIS (anno) { //METTILO NEL START PPE
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.RATERIS].values[indexAnno].value = this.row[this.PPE].values[indexAnno].value
      this.startRATERIS(anno);
    }
    calculatePR (anno) {
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.PR].values[indexAnno].value = this.row[this.DEBFINBT].values[indexAnno].value + this.row[this.FORN].values[indexAnno].value + this.row[this.DFB].values[indexAnno].value + this.row[this.DEBNONFINENTR12MESI].values[indexAnno].value + this.row[this.RATERIS].values[indexAnno].value
      this.startPR(anno);
    }
    calculateCAPCIRNET (anno) { //METTILO NEL START PPE
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.CAPCIRNET].values[indexAnno].value = this.row[this.ATTCORR].values[indexAnno].value - this.row[this.PR].values[indexAnno].value
      this.startCAPCIRNET(anno);
    }
    calculateTOTFON (anno) { //METTILO NEL START PPE
      let indexAnno = 2019 - parseInt(anno)
      this.row[this.TOTFON].values[indexAnno].value = this.row[this.PMLT_PN].values[indexAnno].value + this.row[this.PR].values[indexAnno].value
      this.startTOTFON(anno);
    }
  }
}
